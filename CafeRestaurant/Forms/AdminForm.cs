...
namespace CafeRestaurant.Forms
{
    public partial class AdminForm : Form
    {
        ...
        private int userID;
        private readonly UserService userService = new UserService(new CafeRestaurantEntities()); 
        private int? userRole;
            ...
            private async Task OpenDashboardAsync()
            {
                ...
                var dashboardForm = new DashboardAdminForm(userID)
                {
                    TopLevel = false,
                    TopMost = true,
        ...
        //    userID = userId;
        //    // AddControlsToPanel();
        //    USER user = userService.GetUserByEmailAsync(userId);
        //    userRole = user.USERROLEID;
        //    if (userRole == 2)
        //    {
        //        btnUserInsert.Visible = false;
