...
namespace CafeRestaurant.Forms
{
    public partial class PasswordChangeForm : Form
    {
        ...
        public PasswordChangeForm(LoginService loginService, int userId, string userEmail)
        {
            InitializeComponent();
        ...
        private async void btnPassChange_Click(object sender, EventArgs e)
        {
            ...
            if (_userId != 0)
            {
                await _loginService.ChangePasswordAsync(_userId, newPassword, confirmPassword);
