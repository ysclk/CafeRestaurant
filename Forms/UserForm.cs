...
namespace CafeRestaurant.Forms
{
    public partial class UserForm : Form
    {
        ...
        public UserForm(UserService userService,UserroleService userRoleService, UserRoleRepository userRoleRepository,
        ...
        {
            cbRoles.DataSource = await _userroleRepository.GetAllAsync();
        ...
        private async void btnProdSave_Click(object sender, EventArgs e)
        {
            var user = new USER
            {
                ...
                USERROLEID = (int)cbRoles.SelectedValue
            };
        ...
        private async void btnProdUpdate_Click(object sender, EventArgs e)
        {
            ...
            user.USERROLEID = (int)cbRoles.SelectedValue;
        ...
        private void dgUserList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbRoles.SelectedValue = Convert.ToInt32(row.Cells["ROLEID"].Value);
        }
